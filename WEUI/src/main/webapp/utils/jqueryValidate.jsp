...
<script src="${ctx }/static/jquery/validate/jquery-validation-1.14.0/lib/jquery.js"></script>
<script src="${ctx }/static/jquery/validate/jquery-validation-1.14.0/dist/jquery.validate.min.js"></script>
<script src="${ctx }/static/jquery/validate/jquery-validation-1.14.0/dist/localization/messages_zh.js"></script>
<style>
.error {
	color: red;
}
